...
class NuscenesLoader:
    ...
    def __init__(self, version, dataroot, frequency=2):
        ...
        for sensor_channel in sensor_channels:
            ...
            for ann_token in annotation_tokens:
                ...
                if box_in_image(box, cam_intrinsic, imsize, vis_level=1):
                    ...
                    ann['instance_token'] = ann['instance_token']
...
if __name__ == "__main__":
    ## Test the function
    loader = NuscenesLoader(version="v1.0-mini", dataroot="./workspace/data/nuscenes")
    # sample = loader.nusc.get('sample', "542eaf1fc9b34895a9e55fab57cb4cf4")
    ...
    print(metadata['sample_descriptions'].keys())
    for k in metadata['sample_descriptions'].keys():
        image = Image.open(metadata['sample_descriptions'][k]['filepath'])
        image.save(os.path.join("./workspace/data/vpd-sft/nuscenes/images/00000", metadata['sample_descriptions'][k]['filepath'].split("__")[-1]))
